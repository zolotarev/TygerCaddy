  ...
  <div>
    ...
    >
      <v-list dense nav class="py-0">
        <v-list-item two-line :class="miniVariant && 'px-0'" link to="/profile">
          <v-list-item-avatar>
            <img
              src="https://avataaars.io/?avatarStyle=Circle&topType=Hat&accessoriesType=Prescription02&facialHairType=BeardLight&facialHairColor=Red&clotheType=BlazerShirt&eyeType=EyeRoll&eyebrowType=FlatNatural&mouthType=Smile&skinColor=Pale"
            />
          </v-list-item-avatar>
        ...
        <v-list-group prepend-icon="mdi-apps" value nav no-action color="white">
          <template v-slot:activator>
            <v-list-item-title>Applications</v-list-item-title>
          </template>
          <v-list-item link @click.stop="showAddApp=true">
            <v-list-item-icon>
        ...
        <v-list-group prepend-icon="mdi-link-box-variant-outline" value nav no-action color="white">
          <template v-slot:activator>
        ...
        <v-list-group prepend-icon="mdi-cog" value nav no-action color="white">
          <template v-slot:activator>
        ...
        <v-list-group prepend-icon="mdi-table-settings" value nav no-action color="white">
          <template v-slot:activator>
