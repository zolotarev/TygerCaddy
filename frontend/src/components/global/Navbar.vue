...
export default {
  data: () => ({
    ...
    links: [
      { route: "/", text: "Home", icon: "mdi-home" },
      { route: "apps", text: "Applications", icon: "mdi-apps" },
      { route: "addresses", text: "Addresses", icon: "mdi-domain" },
      { route: "backup", text: "Export Config", icon: "mdi-application-export" },
      { route: "restart", text: "Restart Proxy", icon: "mdi-timelapse" }
    ]
  }),
  computed: {
   email(){
